        ...
        <div class="col-md-12">
            ...
            <div class="card" style="height: 720px; overflow-y: scroll;">
                <div class="card-header">
                    ...
                    <a href="<?= base_url(); ?>pasif" class="fas fa-arrow-circle-left ml-2"></a>
                    Data Peserta
                </div>
                <div class="card-body">
                    ...
                    <main class="container">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <?php
                                // if ($pensiun['img'] !== '') {
                                //     echo base_url('assets/img/profile/') . $pensiun['img'];
                                // } else {
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?= $pensiun['nama']; ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?= $pensiun['npk']; ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?= $pensiun['nopen']; ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?= $pensiun['stpeg']; ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?php /*$hitungan['usia'];*/
                                                                                        ...
                                                                                        $now        = new DateTime();
                                                                                        $lahir        = new DateTime($pensiun['tglhr']);
                    ...
                    <nav class="nav nav-pills nav-justified mb-4">
                        ...
                        <!-- <a class="nav-link" href="<?= base_url(); ?>aktif/detail_simulasi/<?= $pensiun['npk']; ?>">Simulasi Pensiun</a> -->
                        <a class="nav-link" href="<?= base_url(); ?>aktif/riwayat/<?= $pensiun['npk']; ?>">Riwayat Perubahan</a>
                    </nav>

                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">

                            <form action="<?= base_url(); ?>aktif/update_preview/<?= $pensiun['npk'];  ?>" method="post" enctype="multipart/form-data">
                                <p class="card-text">
                                    <b>Data Pribadi</b>
                                </p>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="nama" name="nama" class="form-control" value="<?= $pensiun['nama']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="jk" name="jk" class="form-control">
                                            <?php foreach ($jk as $j) : ?>
                                                <option value="<?= $j['id']; ?>" <?php if ($pensiun['jk'] == $j['id']) {
                                                                                        echo "selected";
                                                                                    } ?>>
                                                    <?= $j['jk']; ?>
                                                </option>
                                    ...
                                    <div class="col-sm-10">
                                        <select id="agama" name="agama" class="form-control">
                                            <?php foreach ($agama as $ag) : ?>
                                                <option value="<?= $ag['id']; ?>" <?php if ($pensiun['agama'] == $ag['id']) {
                                                                                        echo "selected";
                                                                                    } ?>>
                                                    <?= $ag['agama']; ?>
                                                </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="tp_lhr" name="tp_lhr" class="form-control" value="<?= $pensiun['tplhr']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" id="tgl_lhr" name="tgl_lhr" class="form-control" value="<?= $pensiun['tglhr']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="nik" name="nik" class="form-control" value="<?= $pensiun['nik']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="npwp" name="npwp" class="form-control" value="<?= $pensiun['npwp']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="st_peg" name="st_peg" class="form-control" value="<?= $pensiun['stpeg']; ?>" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select id="cabang" name="cabang" class="form-control">
                                            <?php foreach ($cabang as $cab) : ?>
                                                <option value="<?= $cab['cab']; ?>" <?php if ($pensiun['cab'] == $cab['cab']) {
                                                                                        echo "selected";
                                                                                    } ?>>
                                                    <?= $cab['nama_cab']; ?>
                                                </option>
                                ...
                                <div class="form-group row" hidden>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="noreg" name="noreg" class="form-control" value="<?= $pensiun['npk']; ?>" readonly hidden>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" id="tgl_mb" name="tgl_mb" class="form-control" value="<?= $pensiun['tgmlb']; ?>" required readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="golongan" name="golongan" class="form-control" value="<?= $pensiun['gol']; ?>" required readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="phdp" name="phdp" class="form-control" value="<?= $pensiun['phdp']; ?>" required readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="nskst" name="nskst" class="form-control" value="<?= $pensiun['nskst']; ?>" required readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" aria-label="With textarea" id="almt" name="almt" required><?= $pensiun['alamat']; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="rt_rw" name="rt_rw" class="form-control" value="<?= $pensiun['rt_rw']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="kelurahan" name="kelurahan" class="form-control" value="<?= $pensiun['kelurahan']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="kecamatan" name="kecamatan" class="form-control" value="<?= $pensiun['kecamatan']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="kota" name="kota" class="form-control" value="<?= $pensiun['kota']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="kodepos" name="kodepos" class="form-control" value="<?= $pensiun['kodepos']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="phone" name="phone" class="form-control" value="<?= $pensiun['telp']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="hp" name="hp" class="form-control" value="<?= $pensiun['hp']; ?>" required>
                                    </div>
                                </div>



                                <a href="<?= base_url(); ?>aktif/tambah_ahliwaris/<?= $pensiun['npk'] ?>" class="btn btn-success mt-3 mb-3">
